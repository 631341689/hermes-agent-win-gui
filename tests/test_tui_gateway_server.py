...
def test_tui_gateway_entry_importable():
    """Regression: Windows has no SIGPIPE/SIGHUP; entry must not crash on import."""
    import tui_gateway.entry as entry  # noqa: PLC0415 — registers signal handlers
